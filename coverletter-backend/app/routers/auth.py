...
OAUTH_STATE_COOKIE = "cl_oauth_state"
...
async def google_login(request: Request):
    ...
    # No access_type="offline" here — this service only needs identity
    # (sign-in), unlike Sweeps which needs a long-lived Gmail/Calendar grant.
...
async def google_callback(
    ...
    redirect_url = f"{settings.frontend_url}/cover-letters/auth/callback#token={token}"
...
async def get_me(request: Request, user: User = FastApiDepends(get_current_user)):
    return user
